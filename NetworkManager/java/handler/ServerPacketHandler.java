...
public final class ServerPacketHandler implements IServerPacketHandler {
    @Override
    public void handle(lIIlllIIIllIIIIIllIIIllllIllIllI packet) {
    ...
    @Override
    public void handle(llIllllIIIlIIlIIllIlIIIllIIIIIIl packet) {

    }

    @Override
    public void handle(lIlIIIllIlIIIlllIllI serverConstantResult) {
